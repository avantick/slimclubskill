---
name: 痛点爽点痒点洞察
description: This skill should be used when the user needs to apply the "痛点爽点痒点洞察" workflow from the AI prompt collection, especially for 拆解用户行为节点，提炼痛点、爽点、痒点和产品机会。
agent_created: true
---
...
用于把《AI提示词.pdf》中“痛点爽点痒点洞察”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于拆解用户行为节点，提炼痛点、爽点、痒点和产品机会。
