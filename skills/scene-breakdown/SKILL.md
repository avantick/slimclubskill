---
name: 使用场景拆解
description: This skill should be used when the user needs to apply the "使用场景拆解" workflow from the AI prompt collection, especially for 全量拆解产品使用场景和用户需求。
agent_created: true
---
...
用于把《AI提示词.pdf》中“使用场景拆解”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于全量拆解产品使用场景和用户需求。
