---
name: 视频热点复刻
description: This skill should be used when the user needs to apply the "视频热点复刻" workflow from the AI prompt collection, especially for 将热点视频结构复刻为适合品牌的短视频创意方向。
agent_created: true
---
...
用于把《AI提示词.pdf》中“视频热点复刻”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于将热点视频结构复刻为适合品牌的短视频创意方向。
