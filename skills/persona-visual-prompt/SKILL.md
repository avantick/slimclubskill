---
name: 用户画像可视化
description: This skill should be used when the user needs to apply the "用户画像可视化" workflow from the AI prompt collection, especially for 把用户画像转成可用于生成插画或 PPT 的视觉提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“用户画像可视化”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于把用户画像转成可用于生成插画或 PPT 的视觉提示词。
