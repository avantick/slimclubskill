---
name: 一页用户画像PPT
description: This skill should be used when the user needs to apply the "一页用户画像PPT" workflow from the AI prompt collection, especially for 生成一页用户画像 PPT 的内容结构与表达。
agent_created: true
---
...
用于把《AI提示词.pdf》中“一页用户画像PPT”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成一页用户画像 PPT 的内容结构与表达。
