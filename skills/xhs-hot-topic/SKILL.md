---
name: 热点小红书选题
description: This skill should be used when the user needs to apply the "热点小红书选题" workflow from the AI prompt collection, especially for 把热点事件转化为自然植入产品的小红书选题。
agent_created: true
---
...
用于把《AI提示词.pdf》中“热点小红书选题”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于把热点事件转化为自然植入产品的小红书选题。
