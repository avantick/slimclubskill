---
name: 海报图生成广告视频
description: This skill should be used when the user needs to apply the "海报图生成广告视频" workflow from the AI prompt collection, especially for 将海报图转化为广告视频提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“海报图生成广告视频”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于将海报图转化为广告视频提示词。
