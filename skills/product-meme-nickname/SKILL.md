---
name: 产品昵称造梗
description: This skill should be used when the user needs to apply the "产品昵称造梗" workflow from the AI prompt collection, especially for 围绕产品核心卖点生成具传播力的昵称、梗名和口语化记忆点。
agent_created: true
---
...
用于把《AI提示词.pdf》中“产品昵称造梗”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于围绕产品核心卖点生成具传播力的昵称、梗名和口语化记忆点。
