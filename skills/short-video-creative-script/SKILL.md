---
name: 短视频创意脚本
description: This skill should be used when the user needs to apply the "短视频创意脚本" workflow from the AI prompt collection, especially for 把卖点转化为剧情、反转、情绪共鸣或视觉型短视频脚本。
agent_created: true
---
...
用于把《AI提示词.pdf》中“短视频创意脚本”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于把卖点转化为剧情、反转、情绪共鸣或视觉型短视频脚本。
