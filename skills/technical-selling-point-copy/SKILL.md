---
name: 技术功能卖点文案
description: This skill should be used when the user needs to apply the "技术功能卖点文案" workflow from the AI prompt collection, especially for 把技术、成分、功能机制写成具象、可感知的卖点文案。
agent_created: true
---
...
用于把《AI提示词.pdf》中“技术功能卖点文案”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于把技术、成分、功能机制写成具象、可感知的卖点文案。
