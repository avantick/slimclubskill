---
name: 小红书爆款选题
description: This skill should be used when the user needs to apply the "小红书爆款选题" workflow from the AI prompt collection, especially for 用搜索热词、热点采集和人群需求生成小红书爆款选题。
agent_created: true
---
...
用于把《AI提示词.pdf》中“小红书爆款选题”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于用搜索热词、热点采集和人群需求生成小红书爆款选题。
