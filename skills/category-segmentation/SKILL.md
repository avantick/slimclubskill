---
name: 细分品类拆解
description: This skill should be used when the user needs to apply the "细分品类拆解" workflow from the AI prompt collection, especially for 拆解母品类、细分维度和价值进化路径。
agent_created: true
---
...
用于把《AI提示词.pdf》中“细分品类拆解”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于拆解母品类、细分维度和价值进化路径。
