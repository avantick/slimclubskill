---
name: 卖点变买点
description: This skill should be used when the user needs to apply the "卖点变买点" workflow from the AI prompt collection, especially for 把产品卖点转化为用户视角买点和心动文案。
agent_created: true
---
...
用于把《AI提示词.pdf》中“卖点变买点”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于把产品卖点转化为用户视角买点和心动文案。
