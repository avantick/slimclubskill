---
name: 小红书场景种草选题
description: This skill should be used when the user needs to apply the "小红书场景种草选题" workflow from the AI prompt collection, especially for 基于优先场景生成小红书种草选题。
agent_created: true
---
...
用于把《AI提示词.pdf》中“小红书场景种草选题”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于基于优先场景生成小红书种草选题。
