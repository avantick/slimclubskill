---
name: 小红书评论生成
description: This skill should be used when the user needs to apply the "小红书评论生成" workflow from the AI prompt collection, especially for 生成具真实感、观点感和互动性的评论。
agent_created: true
---
...
用于把《AI提示词.pdf》中“小红书评论生成”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成具真实感、观点感和互动性的评论。
