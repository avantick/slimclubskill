---
name: 品牌IP设计提示词
description: This skill should be used when the user needs to apply the "品牌IP设计提示词" workflow from the AI prompt collection, especially for 生成品牌 IP 角色设定、三视图、表情动作和商业应用提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“品牌IP设计提示词”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成品牌 IP 角色设定、三视图、表情动作和商业应用提示词。
