---
name: 一键生成PPT大纲
description: This skill should be used when the user needs to apply the "一键生成PPT大纲" workflow from the AI prompt collection, especially for 根据项目资料生成结构化 PPT 大纲与页面内容。
agent_created: true
---
...
用于把《AI提示词.pdf》中“一键生成PPT大纲”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于根据项目资料生成结构化 PPT 大纲与页面内容。
