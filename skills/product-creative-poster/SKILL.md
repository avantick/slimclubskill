---
name: 产品创意海报
description: This skill should be used when the user needs to apply the "产品创意海报" workflow from the AI prompt collection, especially for 为产品卖点生成创意海报主题、文案和视觉提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“产品创意海报”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于为产品卖点生成创意海报主题、文案和视觉提示词。
