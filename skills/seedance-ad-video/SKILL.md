---
name: Seedance品牌广告视频
description: This skill should be used when the user needs to apply the "Seedance品牌广告视频" workflow from the AI prompt collection, especially for 生成品牌广告类视频提示词和镜头结构。
agent_created: true
---
...
用于把《AI提示词.pdf》中“Seedance品牌广告视频”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成品牌广告类视频提示词和镜头结构。
