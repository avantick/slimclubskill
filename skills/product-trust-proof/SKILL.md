---
name: 产品信任状提炼
description: This skill should be used when the user needs to apply the "产品信任状提炼" workflow from the AI prompt collection, especially for 将成分、技术、数据、背书转化为用户能理解的信任状。
agent_created: true
---
...
用于把《AI提示词.pdf》中“产品信任状提炼”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于将成分、技术、数据、背书转化为用户能理解的信任状。
