---
name: 社媒热点视频提示词
description: This skill should be used when the user needs to apply the "社媒热点视频提示词" workflow from the AI prompt collection, especially for 生成社媒热点类视频创意提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“社媒热点视频提示词”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成社媒热点类视频创意提示词。
