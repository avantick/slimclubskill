---
name: 产品包装设计提示词
description: This skill should be used when the user needs to apply the "产品包装设计提示词" workflow from the AI prompt collection, especially for 生成产品包装视觉方向、画面描述和 AI 绘图提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“产品包装设计提示词”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成产品包装视觉方向、画面描述和 AI 绘图提示词。
