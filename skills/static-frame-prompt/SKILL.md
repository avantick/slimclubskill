---
name: 短视频静帧画面
description: This skill should be used when the user needs to apply the "短视频静帧画面" workflow from the AI prompt collection, especially for 为短视频生成关键静帧画面和视觉提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“短视频静帧画面”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于为短视频生成关键静帧画面和视觉提示词。
