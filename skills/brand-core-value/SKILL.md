---
name: 品牌核心价值提炼
description: This skill should be used when the user needs to apply the "品牌核心价值提炼" workflow from the AI prompt collection, especially for 提炼品牌核心价值、用户承诺和概念表达。
agent_created: true
---
...
用于把《AI提示词.pdf》中“品牌核心价值提炼”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于提炼品牌核心价值、用户承诺和概念表达。
