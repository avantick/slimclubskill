---
name: 大字海报文案
description: This skill should be used when the user needs to apply the "大字海报文案" workflow from the AI prompt collection, especially for 将热点或卖点转化为大字海报短句和视觉方向。
agent_created: true
---
...
用于把《AI提示词.pdf》中“大字海报文案”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于将热点或卖点转化为大字海报短句和视觉方向。
