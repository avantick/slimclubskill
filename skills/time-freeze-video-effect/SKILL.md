---
name: 时间静止视频特效
description: This skill should be used when the user needs to apply the "时间静止视频特效" workflow from the AI prompt collection, especially for 生成时间静止类视频特效提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“时间静止视频特效”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成时间静止类视频特效提示词。
