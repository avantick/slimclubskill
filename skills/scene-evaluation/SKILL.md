---
name: 场景机会评估
description: This skill should be used when the user needs to apply the "场景机会评估" workflow from the AI prompt collection, especially for 评估哪个场景最适合作为品牌突破口和小红书起势点。
agent_created: true
---
...
用于把《AI提示词.pdf》中“场景机会评估”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于评估哪个场景最适合作为品牌突破口和小红书起势点。
