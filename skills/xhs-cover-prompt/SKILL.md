---
name: 小红书封面提示词
description: This skill should be used when the user needs to apply the "小红书封面提示词" workflow from the AI prompt collection, especially for 生成小红书封面标题、版式和视觉提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“小红书封面提示词”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成小红书封面标题、版式和视觉提示词。
