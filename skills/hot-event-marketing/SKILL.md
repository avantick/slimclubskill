---
name: 热点营销创意
description: This skill should be used when the user needs to apply the "热点营销创意" workflow from the AI prompt collection, especially for 根据热点事件和产品卖点生成借势营销创意。
agent_created: true
---
...
用于把《AI提示词.pdf》中“热点营销创意”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于根据热点事件和产品卖点生成借势营销创意。
