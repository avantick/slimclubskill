---
name: 网格分镜提示词
description: This skill should be used when the user needs to apply the "网格分镜提示词" workflow from the AI prompt collection, especially for 把文本或视觉图拆成 16 个关键瞬间的分镜提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“网格分镜提示词”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于把文本或视觉图拆成 16 个关键瞬间的分镜提示词。
