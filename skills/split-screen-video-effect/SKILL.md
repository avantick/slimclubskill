---
name: 上下分屏视频特效
description: This skill should be used when the user needs to apply the "上下分屏视频特效" workflow from the AI prompt collection, especially for 生成上下分屏视频特效和主视觉提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“上下分屏视频特效”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成上下分屏视频特效和主视觉提示词。
