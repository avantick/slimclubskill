---
name: 目标用户细分
description: This skill should be used when the user needs to apply the "目标用户细分" workflow from the AI prompt collection, especially for 基于消费行为和场景识别目标用户画像。
agent_created: true
---
...
用于把《AI提示词.pdf》中“目标用户细分”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于基于消费行为和场景识别目标用户画像。
