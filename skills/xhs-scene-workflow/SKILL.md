---
name: 小红书场景工作流
description: This skill should be used when the user needs to apply the "小红书场景工作流" workflow from the AI prompt collection, especially for 把场景拆解、评估和选题串成完整工作流。
agent_created: true
---
...
用于把《AI提示词.pdf》中“小红书场景工作流”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于把场景拆解、评估和选题串成完整工作流。
