---
name: 行业趋势分析
description: This skill should be used when the user needs to apply the "行业趋势分析" workflow from the AI prompt collection, especially for 分析行业趋势、增长动力、风险和品牌机会。
agent_created: true
---
...
用于把《AI提示词.pdf》中“行业趋势分析”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于分析行业趋势、增长动力、风险和品牌机会。
