---
name: 场景四象限分类
description: This skill should be used when the user needs to apply the "场景四象限分类" workflow from the AI prompt collection, especially for 按高频/低频、刚需/非刚需对场景做四象限归类。
agent_created: true
---
...
用于把《AI提示词.pdf》中“场景四象限分类”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于按高频/低频、刚需/非刚需对场景做四象限归类。
