---
name: 品牌命名提示词
description: This skill should be used when the user needs to apply the "品牌命名提示词" workflow from the AI prompt collection, especially for 为新品或品牌生成、评估和迭代中文品牌名。
agent_created: true
---
...
用于把《AI提示词.pdf》中“品牌命名提示词”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于为新品或品牌生成、评估和迭代中文品牌名。
