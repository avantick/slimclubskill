---
name: AI 图片热身任务
description: This skill should be used when the user needs to apply the "AI 图片热身任务" workflow from the AI prompt collection, especially for 根据上传人物照片生成手办、职业肖像等图像创意提示词。
agent_created: true
---
...
用于把《AI提示词.pdf》中“AI 图片热身任务”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于根据上传人物照片生成手办、职业肖像等图像创意提示词。
