---
name: 细分品类评估
description: This skill should be used when the user needs to apply the "细分品类评估" workflow from the AI prompt collection, especially for 从规模、增速、竞争、机会和风险评估细分品类。
agent_created: true
---
...
用于把《AI提示词.pdf》中“细分品类评估”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于从规模、增速、竞争、机会和风险评估细分品类。
