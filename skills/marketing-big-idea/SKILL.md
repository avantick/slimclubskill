---
name: 营销大创意
description: This skill should be used when the user needs to apply the "营销大创意" workflow from the AI prompt collection, especially for 基于品牌价值和用户洞察生成可长期延展的营销大创意。
agent_created: true
---
...
用于把《AI提示词.pdf》中“营销大创意”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于基于品牌价值和用户洞察生成可长期延展的营销大创意。
