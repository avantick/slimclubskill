---
name: 卖点情绪化文案
description: This skill should be used when the user needs to apply the "卖点情绪化文案" workflow from the AI prompt collection, especially for 将卖点转化为更有情绪价值和场景感染力的表达。
agent_created: true
---
...
用于把《AI提示词.pdf》中“卖点情绪化文案”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于将卖点转化为更有情绪价值和场景感染力的表达。
