---
name: 品牌项目目标对齐
description: This skill should be used when the user needs to apply the "品牌项目目标对齐" workflow from the AI prompt collection, especially for 在开始品牌/产品项目之前，先收集公司、角色、品类和目标，建立统一上下文。
agent_created: true
---
...
用于把《AI提示词.pdf》中“品牌项目目标对齐”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于在开始品牌/产品项目之前，先收集公司、角色、品类和目标，建立统一上下文。
