---
name: 小红书种草爆文
description: This skill should be used when the user needs to apply the "小红书种草爆文" workflow from the AI prompt collection, especially for 生成完整小红书种草笔记正文。
agent_created: true
---
...
用于把《AI提示词.pdf》中“小红书种草爆文”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成完整小红书种草笔记正文。
