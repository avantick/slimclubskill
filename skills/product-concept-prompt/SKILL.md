---
name: 产品Concept生成
description: This skill should be used when the user needs to apply the "产品Concept生成" workflow from the AI prompt collection, especially for 生成完整产品 concept，包括人群、场景、价值、信任状和表达。
agent_created: true
---
...
用于把《AI提示词.pdf》中“产品Concept生成”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成完整产品 concept，包括人群、场景、价值、信任状和表达。
