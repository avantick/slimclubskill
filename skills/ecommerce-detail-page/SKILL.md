---
name: 电商详情页策划
description: This skill should be used when the user needs to apply the "电商详情页策划" workflow from the AI prompt collection, especially for 把产品卖点组织成电商详情页屏次、标题、视觉和转化逻辑。
agent_created: true
---
...
用于把《AI提示词.pdf》中“电商详情页策划”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于把产品卖点组织成电商详情页屏次、标题、视觉和转化逻辑。
