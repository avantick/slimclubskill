---
name: 情绪营销文案
description: This skill should be used when the user needs to apply the "情绪营销文案" workflow from the AI prompt collection, especially for 生成具情绪共鸣、态度表达和社交传播力的文案。
agent_created: true
---
...
用于把《AI提示词.pdf》中“情绪营销文案”相关提示词沉淀为可复用的 WorkBuddy Skill。适用于生成具情绪共鸣、态度表达和社交传播力的文案。
